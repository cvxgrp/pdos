...
cmd = sprintf ('mex -v -O %s CFLAGS="\\$CFLAGS -std=c99 -O2 %s %s" -I../', arr, defines, d) ;
...
% compile indirect
cmd = sprintf('mex -v -O %s CFLAGS="\\$CFLAGS -std=c99 -O2 %s %s" %s ../indirect/private.c -I../ -o pdos_indirect %s', arr, defines, d, common_pdos, link);
eval(cmd);
