...
cmd = sprintf ('mex -v -O %s CFLAGS="-std=c99 -O3 -DMATLAB_MEX_FILE -DLDL_LONG -DDLONG %s" -I../', arr, d) ;
...
% compile indirect
cmd = sprintf('mex -v -O %s CFLAGS="-std=c99 -O3 -DMATLAB_MEX_FILE -DLDL_LONG -DDLONG %s" %s ../indirect/private.c -I../ -o pdos_indirect -lm', arr, d, common_pdos);
eval(cmd);
